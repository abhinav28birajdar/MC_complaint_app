    ...
    <ScrollView style={styles.container}>
        ...
        <Card style={styles.section}>
          ...
          <View style={styles.userContainer}>
            ...
            <View style={styles.userInfo}>
              ...
              <Text style={styles.userContact}>{citizen.phone}</Text>
            </View>
          </View>
        </Card>
      )}
          ...
          <View style={styles.userContainer}>
            ...
            <View style={styles.userInfo}>
              ...
              <Text style={styles.userContact}>
                {employee.department} • {employee.areaAssigned}
              </Text>
            </View>
          </View>
        </Card>
      ...
      >
        <View style={styles.chatButtonContent}>
          ...
          <Text style={styles.chatButtonText}>Chat with {employee ? "Employee" : "Citizen"}</Text>
        </View>
